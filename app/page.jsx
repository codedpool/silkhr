  ...
  return (
    <div className="h-screen flex flex-col bg-[#FEF9EC] overflow-hidden">
      ...
      <header className="flex-shrink-0 px-8 py-4 flex items-center justify-between">
        <span className="text-[#1C1917] tracking-[0.25em] text-xs uppercase" style={{ fontFamily: 'var(--font-geist-mono)' }}>
          SilkHR
        </span>
        <div className="flex items-center gap-5">
          <Link href="/history" className="text-[10px] tracking-widest uppercase text-[#A89F92] hover:text-[#1C1917] transition-colors">
            History
          </Link>
          <span className="text-[10px] tracking-widest uppercase text-[#A89F92]">Interview Setup</span>
        </div>
      </header>
